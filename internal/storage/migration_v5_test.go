...
// pins the version to 5 to prevent v5 migration omission from passing,
...
func TestAC009_MigrationV5_SchemaVersionIsExactly5(t *testing.T) {
	...
	if ver != 5 {
		t.Fatalf("expected schema version exactly 5, got %d", ver)
	}
