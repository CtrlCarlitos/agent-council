...
// cprof-v3 compatibility (AC-009 §3.8 matrix): the executor validity
// gate widens v1|v2 → v1|v2|v3 — a v3 profile passes the algo_version
// gate unchanged, with no toolkit_manifest or codex-block behavior.
...
func TestPolicyExecutor_AcceptsCprofV3AtValidityGate(t *testing.T) {
	...
	if err != nil {
		t.Fatalf("cprof-v3 must pass the validity gate, got: %v", err)
	}
	if proc == nil {
