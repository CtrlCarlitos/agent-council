...
//                                        conversations/<id>.db (0600)
//   {"spawn_sleeper": true}              before init, ignore SIGTERM and
//                                        start a descendant copy of this
//                                        binary in sleep mode (same
//                                        process group); its pid goes to
//                                        .agy-fixture-sleeper-pid
//
